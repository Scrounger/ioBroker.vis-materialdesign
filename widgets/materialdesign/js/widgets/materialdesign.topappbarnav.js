        ...
        function getListItemObj(i, data, jsonData) {
            if (data.drawerItemsDataMethod === 'inputPerEditor') {
                ...
                let obj = {
                    ...
                    iconColor: myMdwHelper.getValueFromData(data.attr('iconDrawerColor' + i), myMdwHelper.getValueFromData(data.iconDrawerColor, '#44739e')),
                    subMenuIconColor: myMdwHelper.getValueFromData(data.attr('subIconDrawerColor' + i), myMdwHelper.getValueFromData(data.subIconDrawerColor, '#44739e')),
                ...
                if (jsonData[i]) {
                    return {
                        ...
                        iconColor: myMdwHelper.getValueFromData(jsonData[i].iconColor, myMdwHelper.getValueFromData(data.iconDrawerColor, '#44739e')),
                        subMenuIconColor: myMdwHelper.getValueFromData(jsonData[i].subMenuIconColor, myMdwHelper.getValueFromData(data.subIconDrawerColor, '#44739e')),
